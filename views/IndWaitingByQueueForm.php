<form id="indWaitingByQueue" class="formInd" action="index.php">
	<input type="hidden" name="ind" value="WaitingByQueue">
	...
	<label for="cluster">Mode</label>
	<select id="mode" name="mode">
		<option value="avg" <?php if(isset($mode) && $mode=='avg') echo "selected" ?>>Moyenne</option>
		<option value="sum" <?php if(isset($mode) && $mode=='sum') echo "selected" ?>>Nombre</option>
	</select>
