<form id="indTopConsoForm" class="formInd" action="index.php">
	<input type="hidden" name="ind" value="TopConso">
	...
	<select id="type" name="type">
		<option value="nbjobs" <?php if(isset($type) && $type=='nbjobs') echo "selected" ?>>Nombre de Jobs</option>
		<option value="consommation" <?php if(isset($type) && $type=='consommation') echo "selected" ?>>Heures CPU</option>
		<option value="attente" <?php if(isset($type) && $type=='attente') echo "selected" ?>>Attente</option>
	</select>
