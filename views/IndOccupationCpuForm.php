<form id="indOccupationCpuForm" class="formInd" action="index.php">
	<input type="hidden" name="ind" value="OccupationCpu">
	...
	<label for="mode">Avec indisponibilité</label>
	<input type="checkbox" id="mode" name="mode" value="1" <?php if(isset($mode) && $mode==1) echo 'checked'; ?>>
