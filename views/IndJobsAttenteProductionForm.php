<form id="indJobsAttenteProductionForm" class="formInd" action="index.php">
	<input type="hidden" name="ind" value="JobsAttenteProduction">
	...
	<label for="mode">Nouveaux</label>
	<input type="checkbox" id="mode" name="mode" value="new" <?php if(isset($mode) && $mode=='new') echo 'checked'; ?>>
